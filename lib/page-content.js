...
(() => {
  function createPageContent() {
    ...
    // Returns a clone of `el` with Steal's own nodes and temporary page
    // changes removed, ready for a format's transform() and lib/serialize.js.
    // Not itself serialized here: callers decide how to turn the returned
    // node into a string.
    function capture(el) {
